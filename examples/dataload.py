...
DATA_PATH = "./droid/"              # UPDATE WITH PATH TO RLDS DATASETS
...
print(sample['obs']['camera/image/varied_camera_2_left_image'].shape)
# print(sample['obs']['raw_language'])
print(sample['obs']['robot_state/cartesian_position'].shape)
